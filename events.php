    ...
    <div class="container">
        <div class="sidebar">
            ...
            <div class="nav">
                ...
                <ul>
                    ...
                    <li id="eventforadminonly" class="active">
                        <a   a href="Events.php">
        ...
        <div class="container-content">
            <div class="header">
                ...
                <span><i class="fa-solid fa-house" id="header-return-index"></i> / <span>Events</span></span>
                </div>
                <div class="user">
            ...
            <div class="content-body">
                <div class="events-body">
                    <div class="event-response" id="event-response">
                        <span id="event-response-message">Successfuly Create</span>
                    </div>
                    <div class="create-event">
                        <form action="" method="POST" id="eventForm">
                            ...
                            <div class="button-group">
                                <button type="submit" id="eventBtn">Submit</button>
                            </div>
                        </form>
                    </div>
